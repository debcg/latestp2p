...
import LogoRight from "../images/caplogoright.png";
import LogoLeft from "../images/caplogoleft.png";
import {
  DashboardOutlined,
  FileTextOutlined,
  SettingOutlined,
  ...
  return (
    ...
    >
      <div className="p-4 flex justify-between items-center">
        ...
        {collapsed ? (
          <>
           <img src={LogoLeft} alt="Logo" className={`${collapsed ? "w-12" : "w-56"}`} />
           <LeftOutlined 
          ...
          <>
          <img src={LogoRight} alt="Logo" className={`${collapsed ? "w-8" : "w-56"}`} />
          <RightOutlined 
            onClick={toggleCollapsed}
            className="text-[#000000] text-xl cursor-pointer"
            style={{ marginTop: "-25px", background: "#fff", borderRadius: "50%", boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.1)", fontSize:"12px", padding:"5px", marginLeft:"5px" }}
      ...
      >
        ...
        <SubMenu
          ...
          title={<Link to="/invoice-queue">Invoice Queue</Link>}
          className={siderClass}
          // className={location.pathname === "invoice-queue" ? "bg-[#0070ad] text-white" : ""}
        ...
        <Menu.Item
          ...
          className={location.pathname === "/metric-definitions" ? "bg-[#0070ad] text-white" : ""}
        >
          <Link to="/metric-definitions" style={{ color: location.pathname === "/metric-definitions" ? "white" : "inherit" }}>
            Metric Definitions
          </Link>
        </Menu.Item>
      </Menu>
